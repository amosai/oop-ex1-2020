...
//	private int edge_count;
//	
//	public class node implements node_info, Comparator<node_info> {
//		
//		private int key;
//		private String info;
//		private Double tag;
...
//		
//		if (this.nodes.containsKey(node1) && this.nodes.containsKey(node2)
//				&& this.neighbors.containsKey(node1) && this.neighbors.containsKey(node2)) { //o(1) contains		
//			if (node1 != node2) //same node
//				if (this.nodes.get(node1) != null || this.nodes.get(node2) != null)
//					
...
//	@Override
//	public Collection<node_info> getV(int node_id) {
//		return this.neighbors.get(node_id).values(); //o(1) <Integer, <Integer, Double>>
//	}
//
//    /**
//     * Delete the node (with the given ID) from the graph -
